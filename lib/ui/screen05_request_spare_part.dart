...
class _SparePartIssuesScreenState extends State<SparePartIssuesScreen> {
  late bool isPartsRequested;

  @override
  void initState() {
    super.initState();
    // Load the saved state from myTask - ADD PROPER IMPORT
    // import 'package:field_technician_demo/app_data.dart';
    isPartsRequested = myTask[widget.selectedIndex].isPartsRequested;
    print('INIT STATE - Parts Requested: $isPartsRequested'); // Debug
  }
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: isPartsRequested
            ...
            // Save the state to myTask
            myTask[widget.selectedIndex].isPartsRequested = true;
            widget.saveTasks(myTask);

            print('SAVED - Parts Requested: ${myTask[widget.selectedIndex].isPartsRequested}'); // Debug
